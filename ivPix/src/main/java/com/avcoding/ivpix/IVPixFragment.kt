...
import com.avcoding.ivpix.adapters.InstantImageAdapter
import com.avcoding.ivpix.adapters.MainImageAdapter
import com.avcoding.ivpix.databinding.ControlsLayoutBinding
import com.avcoding.ivpix.databinding.FragmentPixBinding
import com.avcoding.ivpix.databinding.GridLayoutBinding
import com.avcoding.ivpix.databinding.PermissionsLayoutBinding
import com.avcoding.ivpix.databinding.VideoCounterLayoutBinding
import com.avcoding.ivpix.helpers.*
import com.avcoding.ivpix.interfaces.OnSelectionListener
import com.avcoding.ivpix.models.Img
import com.avcoding.ivpix.models.Options
import com.avcoding.ivpix.models.PixViewModel
import com.avcoding.ivpix.utility.ARG_PARAM_PIX
import com.avcoding.ivpix.utility.ARG_PARAM_PIX_KEY
import com.avcoding.ivpix.utility.CustomItemTouchListener
import com.avcoding.ivpix.utility.PixBindings
import kotlinx.coroutines.*
import java.lang.Runnable
import kotlin.coroutines.cancellation.CancellationException

class IVPixFragment(private val resultCallback: ((PixEventCallback.Results) -> Unit)? = null) :
    ...
    private var permReqLauncher =
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()) { permissions ->
            Log.e("permReqLauncher","${permissions.keys}")
            Log.e("permReqLauncher","${permissions.values}")
            if (permissions.all {
                    it.value
                }) {
    ...
    private fun FragmentActivity.setup() {
        ...
        setFragmentResultListener(ARG_PARAM_PIX_KEY) { _, bundle ->
            ...
            options1?.let {
                this@IVPixFragment.options.preSelectedUrls.apply {
                    clear()
    ...
    private fun setupFastScroller(context: FragmentActivity) {
        ...
        binding.gridLayout.apply {
            ...
            fastscrollHandle.setOnTouchListener(this@IVPixFragment)
        }
    }
    ...
    private fun setupAdapters(context: FragmentActivity) {
        ...
        binding.gridLayout.apply {
            ...
            recyclerView.setupMainRecyclerView(
                context, mainImageAdapter, scrollListener(this@IVPixFragment, binding)
            )
        }
    }
